...
def _train_loader_from_config(cfg, *, train_set=None, transforms=None, sampler=None, **kwargs):
    ...
    if train_set is None:
        ...
        for d in cfg.DATASETS.NAMES:
            data = DATASET_REGISTRY.get(d)(root=_root, personx3d_subpath=cfg.DATASETS.PERSONX3D.SUBPATH, makehuman_subpath=cfg.DATASETS.MAKEHUMAN.SUBPATH, cfg=cfg, **kwargs)
    ...
    if sampler is None:
        ...
        num_cams_per_batch = cfg.DATALOADER.NUM_CAMS_PER_BATCH
...
def _test_loader_from_config(cfg, *, dataset_name=None, test_set=None, num_query=0, transforms=None, **kwargs):
    ...
    if test_set is None:
        ...
        data = DATASET_REGISTRY.get(dataset_name)(root=_root, personx3d_subpath=cfg.DATASETS.PERSONX3D.SUBPATH, makehuman_subpath=cfg.DATASETS.MAKEHUMAN.SUBPATH, cfg=cfg, **kwargs)
        if comm.is_main_process():
            data.show_test()
