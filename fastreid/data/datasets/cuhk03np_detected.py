...
class CUHK03NPDetected(ImageDataset):
    """CUHK03NPDetected.
    ...
    dataset_dir = ''
    dataset_url = ''
    dataset_name = "cukh03np_detected"
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        data_dir = osp.join(self.data_dir, 'cuhk03-np/detected')
        ...
        super(CUHK03NPDetected, self).__init__(train, query, gallery, **kwargs)
