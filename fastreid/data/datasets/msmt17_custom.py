...
class MSMT17Custom(ImageDataset):
    """MSMT17Custom.
    Reference:
    ...
    dataset_url = None
    dataset_name = 'msmt17custom'

    def __init__(self, root='datasets', cfg=None, **kwargs):
        self.dataset_dir = root

        self.dataset_dir = osp.join(self.dataset_dir, cfg.DATASETS.MSMT17_V1_CUSTOM.ROOT)
        ...
        if 'combineall' in kwargs and kwargs['combineall']:
            train += val
        super(MSMT17Custom, self).__init__(train, query, gallery, **kwargs)
