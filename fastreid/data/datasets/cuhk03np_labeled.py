...
class CUHK03NPLabeled(ImageDataset):
    """CUHK03NPLabeled.
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        data_dir = osp.join(self.data_dir, 'cuhk03-np/labeled')
        ...
        super(CUHK03NPLabeled, self).__init__(train, query, gallery, **kwargs)
