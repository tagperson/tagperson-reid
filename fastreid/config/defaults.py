...
_C.MODEL.BACKBONE.WITH_IBN_B = False
...
# Threshold Loss options
_C.MODEL.LOSSES.THRESHOLD = CN()
_C.MODEL.LOSSES.THRESHOLD.T = 0.6
_C.MODEL.LOSSES.THRESHOLD.NORM_FEAT = True
_C.MODEL.LOSSES.THRESHOLD.HARD_MINING = True
_C.MODEL.LOSSES.THRESHOLD.SCALE = 1.0
...
_C.INPUT.AUGMIX.AUG_SEVERITY_RANDOM = CN({"ENABLED": False})
_C.INPUT.AUGMIX.AUG_SEVERITY_RANDOM.MIN = 1
_C.INPUT.AUGMIX.AUG_SEVERITY_RANDOM.MAX = 3
_C.INPUT.AUGMIX.MIXTURE_DEPTH_RANDOM = CN({"ENABLED": False})
_C.INPUT.AUGMIX.MIXTURE_DEPTH_RANDOM.MIN = 1
_C.INPUT.AUGMIX.MIXTURE_DEPTH_RANDOM.MAX = 3
_C.INPUT.AUGMIX.AUG_PROB_COEFF = -1.0
...
# PersonX3D
_C.DATASETS.PERSONX3D = CN()
_C.DATASETS.PERSONX3D.SUBPATH = ''
# MakeHuman
_C.DATASETS.MAKEHUMAN = CN()
_C.DATASETS.MAKEHUMAN.SUBPATH = ['']
_C.DATASETS.MAKEHUMAN.FILTER_FILE_PATH = ['']
_C.DATASETS.MAKEHUMAN.SPLIT_TRAIN_VAL = False
_C.DATASETS.MAKEHUMAN.MAX_SEQ_ID = 40
# MarketCustom
_C.DATASETS.MARKET1501_CUSTOM = CN()
_C.DATASETS.MARKET1501_CUSTOM.ROOT = ''
# MSMT17_V1_Custom
_C.DATASETS.MSMT17_V1_CUSTOM = CN()
_C.DATASETS.MSMT17_V1_CUSTOM.ROOT = ''
...
# Camera balance sample
_C.DATALOADER.CAMERA_BALANCE_SAMPLER = False
_C.DATALOADER.NUM_CAMS_PER_BATCH = 8
...
# Analysis
_C.TEST.ANALYSIS = CN()
_C.TEST.ANALYSIS.RANK_LIST = CN()
_C.TEST.ANALYSIS.RANK_LIST.ENABLED = False
_C.TEST.ANALYSIS.RANK_LIST.SAVE_DIR = 'tmp/rank_list/'
_C.TEST.ANALYSIS.RANK_LIST.SKIP_SAVE_FILE = False
_C.TEST.ANALYSIS.RANK_LIST.SAVE_RETRIEVAL_INFO = False
_C.TEST.ANALYSIS.VISUALIZE_ATTENTION = CN()
_C.TEST.ANALYSIS.VISUALIZE_ATTENTION.ENABLED = False
_C.TEST.ANALYSIS.VISUALIZE_ATTENTION.SAVE_DIR = 'tmp/attention/'
