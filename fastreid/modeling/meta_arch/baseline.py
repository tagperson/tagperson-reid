...
class Baseline(nn.Module):
    ...
    def losses(self, outputs, gt_labels):
        ...
        # if "ThresholdLoss" in loss_names:
        #     loss_dict["loss_threshold_an"] = threshold_loss_an(
        #         pred_features,
        #         gt_labels,
        #         self._cfg.MODEL.LOSSES.THRESHOLD.T,
        #         self._cfg.MODEL.LOSSES.THRESHOLD.NORM_FEAT,
        #         self._cfg.MODEL.LOSSES.THRESHOLD.HARD_MINING,
        #     ) * self._cfg.MODEL.LOSSES.THRESHOLD.SCALE
            
        #     loss_dict["loss_threshold_ap"] = threshold_loss_ap(
        #         pred_features,
        #         gt_labels,
        #         self._cfg.MODEL.LOSSES.THRESHOLD.T,
        #         self._cfg.MODEL.LOSSES.THRESHOLD.NORM_FEAT,
